...
static void Draw_Num_Button(void *btn);
...
static void Command_Select_Meannum(void *btn);//修改喂食量
...
static void Draw_Num_Button(void *btn)
{
  ...
  if(ptr->touch_flag == 0)
  {
    ...
    ILI9341_DrawRectangle(	ptr->start_x,
	  ...
	  {
		  case 1:
			  ILI9341_DispString_EN_CH( ptr->start_x + (ptr->end_x - ptr->start_x - 16*2 )/2,ptr->start_y+ ((ptr->end_y - ptr->start_y-16)/2),"加");
			  break;
		  case 2:
			  ILI9341_DispString_EN_CH( ptr->start_x + (ptr->end_x - ptr->start_x - 16*2 )/2,ptr->start_y+ ((ptr->end_y - ptr->start_y-16)/2),"开灯");
			  break;
		  case 3:
			  ILI9341_DispString_EN_CH( ptr->start_x + (ptr->end_x - ptr->start_x - 16*2 )/2,ptr->start_y+ ((ptr->end_y - ptr->start_y-16)/2),"3");
			  break;
		  case 4:
			  ILI9341_DispString_EN_CH( ptr->start_x + (ptr->end_x - ptr->start_x - 16*2 )/2,ptr->start_y+ ((ptr->end_y - ptr->start_y-16)/2),"4");
			  break;
		  case 5:
			  ILI9341_DispString_EN_CH( ptr->start_x + (ptr->end_x - ptr->start_x - 16*2 )/2,ptr->start_y+ ((ptr->end_y - ptr->start_y-16)/2),"5");
			  break;
		  case 6:
			  ILI9341_DispString_EN_CH( ptr->start_x + (ptr->end_x - ptr->start_x - 16*2 )/2,ptr->start_y+ ((ptr->end_y - ptr->start_y-16)/2),"6");
			  break;
		  case 7:
			  ILI9341_DispString_EN_CH( ptr->start_x + (ptr->end_x - ptr->start_x - 16*2 )/2,ptr->start_y+ ((ptr->end_y - ptr->start_y-16)/2),"7");
			  break;
		  case 9:
			  ILI9341_DispString_EN_CH( ptr->start_x + (ptr->end_x - ptr->start_x - 16*2 )/2,ptr->start_y+ ((ptr->end_y - ptr->start_y-16)/2),"减");
			  break;
		  case 10:
			  ILI9341_DispString_EN_CH( ptr->start_x + (ptr->end_x - ptr->start_x - 16*2 )/2,ptr->start_y+ ((ptr->end_y - ptr->start_y-16)/2),"关灯");
			  break;
	  }
}
  else  /*按键按下*/
...
/**
* @brief  Command_Select_Meannum 处理投喂数量函数
* @param  btn Touch_Button 类型的按键参数
* @retval 无
*/
static void Command_Select_Meannum(void *btn)
{
	  Touch_Button *ptr = (Touch_Button *)btn;
	if(ptr->para==1)
	{
	...
	if(ptr->para==9&&MANUAL_FEED_NUM>0)
	{
		MANUAL_FEED_NUM--;		
	}
			LCD_SetFont(&Font8x16);	
...
static void Command_Clear_Palette(void *btn)
{
		 motor_concrol_right(MANUAL_FEED_NUM);//手动喂食执行函数
			mcu_dp_value_update(DPID_MANUAL_FEED,MANUAL_FEED_NUM); //VALUE型数据上报;
}
